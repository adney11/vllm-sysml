...
# Runs a single inference test, with one test prompt.
# To avoid generating the test prompt everytime, saved the generated test prompt in "mps_test_prompts_single"
...
def create_test_prompts() -> List[Tuple[str, SamplingParams]]:
    ...
    n_token_prompts = {}
    with open(os.path.join(tests_path, "random_prompts_llama.csv"), "r") as fr:
...
def main(args: argparse.Namespace):
    ...
    with open("mps_test_prompts_single", 'rb') as fp:
        test_prompts = list(pickle.load(fp))
    
    # with open("mps_test_prompts_single", "wb") as fp:
    #     pickle.dump(test_prompts,fp)
